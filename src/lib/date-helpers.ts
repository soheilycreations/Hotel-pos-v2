 ...
 * business-date stamp, or expense-filing action must go through these
 * helpers instead of ad-hoc Date math — this is the ONE sanctioned source of
 * "today" in the system (ported from the old system's colombo-date.ts,
 * where a single call site bypassed it and misfiled data in that window).
 */
